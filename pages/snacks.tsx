...
const Body = dynamic(() => import("../components/snacks/Body"));
          ...
          <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">
              ...
              <a
                ...
                className="text-gray-500 ml-1 hover:text-gray-200"
                target="_blank"
            ...
            <a
              className="inline-flex items-center rounded-full bg-stone-900 px-8 py-3 text-gray-600 hover:bg-stone-800 hover:text-white focus:outline-none focus:ring active:bg-white/90"
              href="#"
            >
