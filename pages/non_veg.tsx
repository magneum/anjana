...
const Body = dynamic(() => import("../components/nveg/Body"));
          ...
          <div className="relative">
            ...
            <div className="relative bg-stone-900 bg-opacity-70">
              <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 text-center">
                <p className="font-bold font-major mt-4 text-lg text-red-600 opacity-80 lg:text-4xl tracking-tighter">
                  <span>Healthy, Light, Delight!</span>
                </p>
                <h2 className="font-bold font-sacramento text-6xl sm:text-6xl md:text-7xl lg:text-8xl text-red-500 opacity-95 text-center">
                  Craving Center
                </h2>
                <h2 className="text-xl italic font-mono text-red-500 lg:text-3xl opacity-95 text-clip">
