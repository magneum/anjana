...
export default function Body() {
  return (
    <section className="bg-gradient-to-br from-stone-900 via-stone-900 to-[#222b30] backdrop-blur-md">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-gradient-to-r from-[#3b3c3f] to-[#454949] shadow-lg">
              <Image
...
<p className="leading-relaxed mb-3 text-gray-100">
<span className="text-gray-300 font-bold">1.</span> 100g
Shemin’s Indian Curry Paste<br></br>
<span className="text-gray-300 font-bold">2.</span> 2
tsp Shemin’s Garam Masala<br></br>
<span className="text-gray-300 font-bold">3.</span>
375ml full fat yoghurt<br></br>
<span className="text-gray-300 font-bold">4.</span> 1
tsp salt (optional)<br></br>
<span className="text-gray-300 font-bold">5.</span> 750g
skinless, boneless chicken breasts, halved lengthwise into
strips<br></br>
<span className="text-gray-300 font-bold">6.</span> 2
tbsp oil<br></br>
<span className="text-gray-300 font-bold">7.</span> 1
small onion, thinly sliced<br></br>
<span className="text-gray-300 font-bold">8.</span> 1
tbsp tomato paste<br></br>
<span className="text-gray-300 font-bold">9.</span> 6
cardamom pods, crushed (optional)<br></br>
<span className="text-gray-300 font-bold">10.</span> 1 x
400g can chopped tomatoes<br></br>
<span className="text-gray-300 font-bold">11.</span> 2
small green chillies, split (optional)<br></br>
<span className="text-gray-300 font-bold">12.</span>
100ml whipping cream<br></br>
<span className="text-gray-300 font-bold">13.</span> 3/4
cup chopped fresh coriander plus sprigs for garnish
<br></br>
<span className="text-gray-300 font-bold">14.</span>
Juice of 1 gray or lemon<br></br>
<span className="text-gray-300 font-bold">15.</span>
...
Tomato, chilli, onions, ginger paste<br></br>
<span className="text-gray-300 font-bold">5.</span>
Turmeric powder, salt, gray chilli powder.<br></br>
</p>
</div>
</div>
</div> */}
